...
#        ## OPEN OMUKAI 2005 FOR COMPARISON
        ...
        pyplot.text(xO[i], yO[i], 'O', fontsize=16)
        pyplot.text(xOH[i], yOH[i], 'OH', fontsize=16)
        pyplot.text(xH2O[i], yH2O[i], 'H$_2$O', fontsize=16)
        ...
        if my_chemistry.metal_cooling:
            ...
            output = "freefall"
        pyplot.savefig("%s_Water_O_[ZH]=%d.pdf" % (output, logZ[i]))
        pyplot.clf()
...
#        pyplot.figure(dpi=1000)
        ...
        pyplot.text(xH2[i], yH2[i], r'H$_2$', fontsize=16)
        pyplot.text(xe[i], ye[i], 'e', fontsize=16)
        pyplot.text(xHD[i], yHD[i], 'HD', fontsize=16)
        ...
        pyplot.savefig("%s_Water_H2_[ZH]=%d.pdf" % (output, logZ[i]))
        pyplot.clf()
       ...
       # pyplot.ylim(ymin = -20, ymax = -8)
        ...
        pyplot.text(xCplus[i], yCplus[i], 'C+', fontsize=16)
        pyplot.text(xC[i], yC[i], 'C', fontsize=16)
        pyplot.text(xCO[i], yCO[i], 'CO', fontsize=16)
        ...
        pyplot.savefig("%s_Water_C_[ZH]=%d.pdf" % (output, logZ[i]))
        pyplot.clf()
