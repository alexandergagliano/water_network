...
_grackle_to_yt = {
 ...
 #ADDED BY ALEX GAGLIANO FOR WATER TESTING
    'H2O'    : ('gas', 'H2O_density'),
    'O'      : ('gas', 'O_density'),
    'OH'     : ('gas', 'OH_density'),
    'O2'     : ('gas', 'O2_density'),
    'Oplus'  : ('gas', 'Oplus_density'),
    'OHplus' : ('gas', 'OHplus_density'),
    'H2Oplus': ('gas', 'H2Oplus_density'),
    'H3Oplus': ('gas', 'H3Oplus_density'),
    'O2plus' : ('gas', 'O2plus_density'),
    'Cplus'  : ('gas', 'Cplus_density'),
    'C'      : ('gas', 'C_density'),
    'CH'     : ('gas', 'CH_density'),  
    'CH2'    : ('gas', 'CH2_density'),
    'CH3'    : ('gas', 'CH3_density'),
