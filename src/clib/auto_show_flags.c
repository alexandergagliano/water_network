...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"CPP = \n");
   fprintf (fp,"CC  = /usr/projects/hpcsoft/toss3/common/x86_64/gcc/5.3.0/bin/gcc\n");
   fprintf (fp,"CXX = /usr/projects/hpcsoft/toss3/common/x86_64/gcc/5.3.0/bin/g++\n");
   fprintf (fp,"FC  = /usr/projects/hpcsoft/toss3/common/x86_64/gcc/5.3.0/bin/gfortran\n");
   fprintf (fp,"F90 = /usr/projects/hpcsoft/toss3/common/x86_64/gcc/5.3.0/bin/gfortran\n");
   fprintf (fp,"LD  = /usr/projects/hpcsoft/toss3/common/x86_64/gcc/5.3.0/bin/gcc\n");
   ...
   fprintf (fp,"LDFLAGS  = -lm -lgsl -lgslcblas -lgfortran \n");
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/usr/lib -lhdf5 -lz  -lgfortran \n");
   fprintf (fp,"\n");
}
